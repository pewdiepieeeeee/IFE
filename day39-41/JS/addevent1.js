...
document.getElementById("region-radio-wrapper").addEventListener("click", pushstate);
document.getElementById("product-radio-wrapper").addEventListener("click", pushstate);
